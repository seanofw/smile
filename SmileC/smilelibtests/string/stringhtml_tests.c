...
{
	AssertString(String_HtmlEncode(String_Empty), NULL, 0);
}
END_TEST
...
{
	AssertString(String_HtmlEncodeToAscii(String_Empty), NULL, 0);
}
END_TEST
...
{
	AssertString(String_HtmlDecode(String_Empty), NULL, 0);
}
END_TEST

START_TEST(UnencodedStringsShouldHtmlDecodeToUnencodedStrings)
{
	AssertString(String_HtmlDecode(String_FromC("This is a test.")), "This is a test.", 15);
}
END_TEST

START_TEST(HtmlDecodeShouldDecodeTheAsciiNamedEntities)
{
	AssertString(String_HtmlDecode(String_FromC("&lt;This &apos;is &amp; a &quot;test.&quot;&gt;")), "<This 'is & a \"test.\">", 22);
}
END_TEST

START_TEST(HtmlDecodeShouldDecodeNamedLatin1EntitiesToUtf8)
{
	AssertString(String_HtmlDecode(String_FromC("&nbsp;This &Aacute;is &frac12; a &aacute;test.&yuml;&THORN;")), "\xC2\xA0This \xC3\x81is \xC2\xBD a \xC3\xA1test.\xC3\xBF\xC3\x9E", 28);
}
END_TEST

START_TEST(HtmlDecodeShouldDecodeNamedNonLatin1EntitiesToUtf8)
{
	AssertString(String_HtmlDecode(String_FromC("&Sigma;This &alpha;is &Yuml; a &mdash;test.&forall;&hearts;")), "\xCE\xA3This \xCE\xB1is \xC5\xB8 a \xE2\x80\x94test.\xE2\x88\x80\xE2\x99\xA5", 31);
}
END_TEST

START_TEST(HtmlDecodeShouldDecodeNumericLatin1EntitiesToUtf8)
{
	AssertString(String_HtmlDecode(String_FromC("&#160;This &#193;is &#189; a &#225;test.&#255;&#222;")), "\xC2\xA0This \xC3\x81is \xC2\xBD a \xC3\xA1test.\xC3\xBF\xC3\x9E", 28);
}
END_TEST

START_TEST(HtmlDecodeShouldDecodeDecimalNonLatin1EntitiesToUtf8)
{
	AssertString(String_HtmlDecode(String_FromC("&#931;This &#945;is &#376; a &#8212;test.&#8704;&#9829;")), "\xCE\xA3This \xCE\xB1is \xC5\xB8 a \xE2\x80\x94test.\xE2\x88\x80\xE2\x99\xA5", 31);
}
END_TEST
...
{
	AssertString(String_HtmlDecode(String_FromC("&#0;This &#1;is &#10; a &#65;test.&#27;&#32;")), "\0This \1is \n a Atest.\x1B ", 22);
}
END_TEST
...
{
	AssertString(String_HtmlDecode(String_FromC("&frog;This is a test.")), "&frog;This is a test.", 15 + 6);
	AssertString(String_HtmlDecode(String_FromC("&#;This is a test.")), "&#;This is a test.", 15 + 3);
	AssertString(String_HtmlDecode(String_FromC("&#15f;This is a test.")), "&#15f;This is a test.", 15 + 6);
	AssertString(String_HtmlDecode(String_FromC("&#frog;This is a test.")), "&#frog;This is a test.", 15 + 7);
	AssertString(String_HtmlDecode(String_FromC("&#x;This is a test.")), "&#x;This is a test.", 15 + 4);
	AssertString(String_HtmlDecode(String_FromC("&#xz;This is a test.")), "&#xz;This is a test.", 15 + 5);
	AssertString(String_HtmlDecode(String_FromC("&#x15z;This is a test.")), "&#x15z;This is a test.", 15 + 7);
}
END_TEST
...
{
	AssertString(String_UrlEncode(String_Empty), NULL, 0);
}
END_TEST
...
{
	AssertString(String_UrlQueryEncode(String_Empty), NULL, 0);
}
END_TEST
...
{
	AssertString(String_UrlDecode(String_Empty), NULL, 0);
}
END_TEST
...
START_TEST(UrlDecodeShouldDecodeDangerousCharactersFromEscapes)
{
	...
	AssertString(String_UrlDecode(str), expectedResult, StrLen(expectedResult));
}
END_TEST
...
START_TEST(UrlDecodeShouldDecodeUppercaseNonAsciiCharacters)
{
	...
	AssertString(String_UrlDecode(str), "This\0is\r\na\x7F\xC2\xA0test.", 18);
}
END_TEST
