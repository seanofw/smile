...
typedef enum SmileSpecialSymbolEnum {
	...
	SMILE_SPECIAL_SYMBOL_COLON_NAME	= 53,
	SMILE_SPECIAL_SYMBOL_RANGE	= 54,
	SMILE_SPECIAL_SYMBOL_UNARY	= 55,
	SMILE_SPECIAL_SYMBOL_POSTFIX	= 56,
	SMILE_SPECIAL_SYMBOL_DOUBLEHASH	= 57,
	SMILE_SPECIAL_SYMBOL_DOT	= 58,
...
typedef struct KnownSymbolsStruct {
	...
	Symbol STMT, EXPR, CMPEXPR, ADDEXPR, MULEXPR, BINARYEXPR, COLON, RANGE, UNARY, POSTFIX, DOUBLEHASH, DOT, TERM;
