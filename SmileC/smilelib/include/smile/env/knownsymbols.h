...
typedef enum SmileSpecialSymbolEnum {
	...
	SMILE_SPECIAL_SYMBOL_RETURN	= 24,
	SMILE_SPECIAL_SYMBOL_TRY	= 25,
	SMILE_SPECIAL_SYMBOL_CATCH	= 26,
	SMILE_SPECIAL_SYMBOL_NOT	= 27,
	SMILE_SPECIAL_SYMBOL_OR	= 28,
	SMILE_SPECIAL_SYMBOL_AND	= 29,		
	SMILE_SPECIAL_SYMBOL_NEW	= 30,
	SMILE_SPECIAL_SYMBOL_IS	= 31,
	SMILE_SPECIAL_SYMBOL_TYPEOF	= 32,
		
	// Comparison punctuation.	
	SMILE_SPECIAL_SYMBOL_SUPEREQ	= 33,
	SMILE_SPECIAL_SYMBOL_SUPERNE	= 34,	
	SMILE_SPECIAL_SYMBOL_EQ	= 35,
	SMILE_SPECIAL_SYMBOL_NE	= 36,
	SMILE_SPECIAL_SYMBOL_LT	= 37,
	SMILE_SPECIAL_SYMBOL_GT	= 38,
	SMILE_SPECIAL_SYMBOL_LE	= 39,
	SMILE_SPECIAL_SYMBOL_GE	= 40,
		
	// Arithmetic.	
	SMILE_SPECIAL_SYMBOL_PLUS	= 41,
	SMILE_SPECIAL_SYMBOL_MINUS	= 42,
	SMILE_SPECIAL_SYMBOL_STAR	= 43,
	SMILE_SPECIAL_SYMBOL_SLASH	= 44,
		
	// Braces and brackets.	
	SMILE_SPECIAL_SYMBOL_LEFTPARENTHESIS	= 45,
	SMILE_SPECIAL_SYMBOL_RIGHTPARENTHESIS	= 46,
	SMILE_SPECIAL_SYMBOL_LEFTBRACKET	= 47,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACKET	= 48,
	SMILE_SPECIAL_SYMBOL_LEFTBRACE	= 49,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACE	= 50,
		
	// Other punctuation.	
	SMILE_SPECIAL_SYMBOL_COMMA	= 51,
	SMILE_SPECIAL_SYMBOL_SEMICOLON	= 52,
	SMILE_SPECIAL_SYMBOL_COLON	= 53,
	SMILE_SPECIAL_SYMBOL_QUESTIONMARK	= 54,
	SMILE_SPECIAL_SYMBOL_IMPLIES	= 55,
	SMILE_SPECIAL_SYMBOL_CARET	= 56,
	SMILE_SPECIAL_SYMBOL_SHL	= 57,
	SMILE_SPECIAL_SYMBOL_SHR	= 58,
	SMILE_SPECIAL_SYMBOL_SAL	= 59,
	SMILE_SPECIAL_SYMBOL_SAR	= 60,
	SMILE_SPECIAL_SYMBOL_ROL	= 61,
	SMILE_SPECIAL_SYMBOL_ROR	= 62,
		
	// Special #syntax classes.	
	SMILE_SPECIAL_SYMBOL_STMT	= 63,
	SMILE_SPECIAL_SYMBOL_EXPR	= 64,
	SMILE_SPECIAL_SYMBOL_CMPEXPR	= 65,
	SMILE_SPECIAL_SYMBOL_ADDEXPR	= 66,
	SMILE_SPECIAL_SYMBOL_MULEXPR	= 67,
	SMILE_SPECIAL_SYMBOL_BINARYEXPR	= 68,
	SMILE_SPECIAL_SYMBOL_COLONEXPR	= 69,
	SMILE_SPECIAL_SYMBOL_RANGEEXPR	= 70,
	SMILE_SPECIAL_SYMBOL_PREFIXEXPR	= 71,
	SMILE_SPECIAL_SYMBOL_POSTFIXEXPR	= 72,
	SMILE_SPECIAL_SYMBOL_CONSEXPR	= 73,
	SMILE_SPECIAL_SYMBOL_DOTEXPR	= 74,
	SMILE_SPECIAL_SYMBOL_TERM	= 75,
