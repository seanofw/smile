...
SMILE_API_FUNC String ByteCodeSegment_ToString(ByteCodeSegment segment, struct CompiledTablesStruct *compiledTables);
SMILE_API_FUNC String ByteCode_ToString(ByteCode byteCode, Int address, struct CompiledTablesStruct *compiledTables);
