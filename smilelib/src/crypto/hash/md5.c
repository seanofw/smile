...
void Md5_Update(Md5Context *ctx, const Byte *data, UInt32 size)
{
	UInt32 saved_lo;
...
void Md5_Finish(Md5Context *ctx, Byte *result)
{
	unsigned long used, available;
...
void Md5(Byte *result, const Byte *buffer, Int size)
{
	Md5Context context;
	Md5_Init(&context);
