...
static void Int32Int32DictInt_Resize(struct Int32Int32DictInt *self, Int32 newLen)
{
	...
	if ((PtrInt)newLen > PtrIntMax / sizeof(struct Int32Int32DictNode)) Smile_Abort_OutOfMemory();
...
Bool Int32Int32Dict_ForEach(Int32Int32Dict intDict, Bool (*func)(Int32 key, Int32 value, void *param), void *param)
{
	struct Int32Int32DictInt *self;
	Int32 bucket, nodeIndex;
	Int32 *buckets;
