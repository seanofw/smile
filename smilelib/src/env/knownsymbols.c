...
STATIC_STRING(CharArray_, "CharArray");
...
STATIC_STRING(SetBase_, "SetBase");
...
STATIC_STRING(UniArray_, "UniArray");
...
STATIC_STRING(NumericSet_, "NumericSet");
...
STATIC_STRING(IntegerSet_, "IntegerSet");
STATIC_STRING(IntegerSetBase_, "IntegerSetBase");
...
STATIC_STRING(ByteSet_, "ByteSet");
...
STATIC_STRING(Integer16Set_, "Integer16Set");
...
STATIC_STRING(Integer32Set_, "Integer32Set");
...
STATIC_STRING(Integer128Set_, "Integer128Set");
...
STATIC_STRING(RealSet_, "RealSet");
STATIC_STRING(RealSetBase_, "RealSetBase");
...
STATIC_STRING(Real32Set_, "Real32Set");
...
STATIC_STRING(Real128Set_, "Real128Set");
...
STATIC_STRING(FloatSet_, "FloatSet");
STATIC_STRING(FloatSetBase_, "FloatSetBase");
...
STATIC_STRING(Float32Set_, "Float32Set");
...
STATIC_STRING(Float128Set_, "Float128Set");
...
static void KnownSymbolsInt_PreloadTypenames(SymbolTable symbolTable, KnownSymbols knownSymbols)
{
	...
	knownSymbols->CharArray_ = SymbolTableInt_AddFast(symbolTable, CharArray_);
	knownSymbols->CharSet_ = SymbolTableInt_AddFast(symbolTable, CharSet_);
	knownSymbols->CharMap_ = SymbolTableInt_AddFast(symbolTable, CharMap_);
	...
	knownSymbols->Set_ = SymbolTableInt_AddFast(symbolTable, Set_);
	knownSymbols->SetBase_ = SymbolTableInt_AddFast(symbolTable, SetBase_);
	...
	knownSymbols->StringSet_ = SymbolTableInt_AddFast(symbolTable, StringSet_);
	...
	knownSymbols->SymbolSet_ = SymbolTableInt_AddFast(symbolTable, SymbolSet_);
	knownSymbols->Uni_ = SymbolTableInt_AddFast(symbolTable, Uni_);
	knownSymbols->UniArray_ = SymbolTableInt_AddFast(symbolTable, UniArray_);
	knownSymbols->UniMap_ = SymbolTableInt_AddFast(symbolTable, UniMap_);
	knownSymbols->UniSet_ = SymbolTableInt_AddFast(symbolTable, UniSet_);
	...
	knownSymbols->NumericSet_ = SymbolTableInt_AddFast(symbolTable, NumericSet_);
	...
	knownSymbols->IntegerSet_ = SymbolTableInt_AddFast(symbolTable, IntegerSet_);
	knownSymbols->IntegerSetBase_ = SymbolTableInt_AddFast(symbolTable, IntegerSetBase_);
	...
	knownSymbols->ByteSet_ = SymbolTableInt_AddFast(symbolTable, ByteSet_);
	...
	knownSymbols->Integer16Set_ = SymbolTableInt_AddFast(symbolTable, Integer16Set_);
	...
	knownSymbols->Integer32Set_ = SymbolTableInt_AddFast(symbolTable, Integer32Set_);
	...
	knownSymbols->Integer64Set_ = SymbolTableInt_AddFast(symbolTable, Integer64Set_);
	...
	knownSymbols->Integer128Set_ = SymbolTableInt_AddFast(symbolTable, Integer128Set_);
	...
	knownSymbols->RealSet_ = SymbolTableInt_AddFast(symbolTable, RealSet_);
	knownSymbols->RealSetBase_ = SymbolTableInt_AddFast(symbolTable, RealSetBase_);
	...
	knownSymbols->Real32Set_ = SymbolTableInt_AddFast(symbolTable, Real32Set_);
	...
	knownSymbols->Real64Set_ = SymbolTableInt_AddFast(symbolTable, Real64Set_);
	...
	knownSymbols->Real128Set_ = SymbolTableInt_AddFast(symbolTable, Real128Set_);
	...
	knownSymbols->FloatSet_ = SymbolTableInt_AddFast(symbolTable, FloatSet_);
	knownSymbols->FloatSetBase_ = SymbolTableInt_AddFast(symbolTable, FloatSetBase_);
	...
	knownSymbols->Float32Set_ = SymbolTableInt_AddFast(symbolTable, Float32Set_);
	...
	knownSymbols->Float64Set_ = SymbolTableInt_AddFast(symbolTable, Float64Set_);
	...
	knownSymbols->Float128Set_ = SymbolTableInt_AddFast(symbolTable, Float128Set_);
}
...
STATIC_STRING(big_float, "big-float");
STATIC_STRING(big_int, "big-int");
STATIC_STRING(big_real, "big-real");
...
STATIC_STRING(byte_range, "byte-range");
...
STATIC_STRING(char_, "char");
STATIC_STRING(char_map, "char-map");
STATIC_STRING(char_set, "char-set");
...
STATIC_STRING(float64_, "float64");
STATIC_STRING(float64_map, "float64-map");
STATIC_STRING(float64_range, "float64-range");
STATIC_STRING(float64_set, "float64-set");
STATIC_STRING(float128_, "float128");
...
STATIC_STRING(integer16_, "integer16");
STATIC_STRING(integer16_range, "integer16-range");
STATIC_STRING(integer32_, "integer32");
STATIC_STRING(integer32_range, "integer32-range");
STATIC_STRING(integer64_, "integer64");
STATIC_STRING(integer64_map, "integer64-map");
STATIC_STRING(integer64_range, "integer64-range");
STATIC_STRING(integer64_set, "integer64-set");
STATIC_STRING(integer128_, "integer128");
...
STATIC_STRING(parse_decl, "parse-decl");
STATIC_STRING(parse_message, "parse-message");
...
STATIC_STRING(primitive, "primitive");
...
STATIC_STRING(real_, "real");
STATIC_STRING(real32_, "real32");
STATIC_STRING(real32_range, "real32-range");
STATIC_STRING(real64_, "real64");
STATIC_STRING(real64_map, "real64-map");
STATIC_STRING(real64_range, "real64-range");
STATIC_STRING(real64_set, "real64-set");
STATIC_STRING(real128_, "real128");
...
STATIC_STRING(string_, "string");
STATIC_STRING(string_map, "string-map");
STATIC_STRING(string_set, "string-set");
...
STATIC_STRING(symbol_map, "symbol-map");
STATIC_STRING(symbol_math, "symbol-math");
STATIC_STRING(symbol_set, "symbol-set");
...
STATIC_STRING(uni_, "uni");
STATIC_STRING(uni_map, "uni-map");
STATIC_STRING(uni_set, "uni-set");
...
STATIC_STRING(user_object, "user-object");
...
static void KnownSymbolsInt_PreloadGeneralSymbols(SymbolTable symbolTable, KnownSymbols knownSymbols)
{
	...
	knownSymbols->big_float = SymbolTableInt_AddFast(symbolTable, big_float);
	knownSymbols->big_int = SymbolTableInt_AddFast(symbolTable, big_int);
	knownSymbols->big_real = SymbolTableInt_AddFast(symbolTable, big_real);
	...
	knownSymbols->byte_range = SymbolTableInt_AddFast(symbolTable, byte_range);
	...
	knownSymbols->char_ = SymbolTableInt_AddFast(symbolTable, char_);
	knownSymbols->char_map = SymbolTableInt_AddFast(symbolTable, char_map);
	knownSymbols->char_set = SymbolTableInt_AddFast(symbolTable, char_set);
	...
	knownSymbols->facade = SymbolTableInt_AddFast(symbolTable, facade);
	...
	knownSymbols->float64_ = SymbolTableInt_AddFast(symbolTable, float64_);
	knownSymbols->float64_map = SymbolTableInt_AddFast(symbolTable, float64_map);
	knownSymbols->float64_range = SymbolTableInt_AddFast(symbolTable, float64_range);
	knownSymbols->float64_set = SymbolTableInt_AddFast(symbolTable, float64_set);
	knownSymbols->float128_ = SymbolTableInt_AddFast(symbolTable, float128_);
	...
	knownSymbols->handle = SymbolTableInt_AddFast(symbolTable, handle);
	...
	knownSymbols->integer16_ = SymbolTableInt_AddFast(symbolTable, integer16_);
	knownSymbols->integer16_range = SymbolTableInt_AddFast(symbolTable, integer16_range);
	knownSymbols->integer32_ = SymbolTableInt_AddFast(symbolTable, integer32_);
	knownSymbols->integer32_range = SymbolTableInt_AddFast(symbolTable, integer32_range);
	knownSymbols->integer64_ = SymbolTableInt_AddFast(symbolTable, integer64_);
	knownSymbols->integer64_map = SymbolTableInt_AddFast(symbolTable, integer64_map);
	knownSymbols->integer64_range = SymbolTableInt_AddFast(symbolTable, integer64_range);
	knownSymbols->integer64_set = SymbolTableInt_AddFast(symbolTable, integer64_set);
	knownSymbols->integer128_ = SymbolTableInt_AddFast(symbolTable, integer128_);
	...
	knownSymbols->macro = SymbolTableInt_AddFast(symbolTable, macro);
	...
	knownSymbols->parse_decl = SymbolTableInt_AddFast(symbolTable, parse_decl);
	knownSymbols->parse_message = SymbolTableInt_AddFast(symbolTable, parse_message);
	...
	knownSymbols->primitive = SymbolTableInt_AddFast(symbolTable, primitive);
	...
	knownSymbols->real_ = SymbolTableInt_AddFast(symbolTable, real_);
	knownSymbols->real32_ = SymbolTableInt_AddFast(symbolTable, real32_);
	knownSymbols->real32_range = SymbolTableInt_AddFast(symbolTable, real32_range);
	knownSymbols->real64_ = SymbolTableInt_AddFast(symbolTable, real64_);
	knownSymbols->real64_map = SymbolTableInt_AddFast(symbolTable, real64_map);
	knownSymbols->real64_range = SymbolTableInt_AddFast(symbolTable, real64_range);
	knownSymbols->real64_set = SymbolTableInt_AddFast(symbolTable, real64_set);
	knownSymbols->real128_ = SymbolTableInt_AddFast(symbolTable, real128_);
	...
	knownSymbols->set = SymbolTableInt_AddFast(symbolTable, set);
	...
	knownSymbols->string_ = SymbolTableInt_AddFast(symbolTable, string_);
	knownSymbols->string_map = SymbolTableInt_AddFast(symbolTable, string_map);
	knownSymbols->string_set = SymbolTableInt_AddFast(symbolTable, string_set);
	...
	knownSymbols->symbol_map = SymbolTableInt_AddFast(symbolTable, symbol_map);
	...
	knownSymbols->symbol_set = SymbolTableInt_AddFast(symbolTable, symbol_set);
	knownSymbols->syntax = SymbolTableInt_AddFast(symbolTable, syntax);
	...
	knownSymbols->uni_ = SymbolTableInt_AddFast(symbolTable, uni_);
	knownSymbols->uni_map = SymbolTableInt_AddFast(symbolTable, uni_map);
	knownSymbols->uni_set = SymbolTableInt_AddFast(symbolTable, uni_set);
	...
	knownSymbols->user_object = SymbolTableInt_AddFast(symbolTable, user_object);
