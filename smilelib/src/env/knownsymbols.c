...
STATIC_STRING(d, "d");
STATIC_STRING(day, "day");
STATIC_STRING(days, "days");
STATIC_STRING(day_of_year, "day-of-year");
...
STATIC_STRING(hour, "hour");
STATIC_STRING(hours, "hours");
...
STATIC_STRING(leap_year_, "leap-year?");
...
STATIC_STRING(minute, "minute");
STATIC_STRING(minutes, "minutes");
STATIC_STRING(mod, "mod");
STATIC_STRING(month, "month");
STATIC_STRING(months, "months");
STATIC_STRING(name, "name");
STATIC_STRING(nanos, "nanos");
...
STATIC_STRING(second, "second");
STATIC_STRING(seconds, "seconds");
...
STATIC_STRING(year, "year");
STATIC_STRING(years, "years");
...
static void KnownSymbolsInt_PreloadGeneralSymbols(SymbolTable symbolTable, KnownSymbols knownSymbols)
{
	...
	knownSymbols->day = SymbolTableInt_AddFast(symbolTable, day);
	knownSymbols->days = SymbolTableInt_AddFast(symbolTable, days);
	knownSymbols->day_of_year = SymbolTableInt_AddFast(symbolTable, day_of_year);
	...
	knownSymbols->hour = SymbolTableInt_AddFast(symbolTable, hour);
	knownSymbols->hours = SymbolTableInt_AddFast(symbolTable, hours);
	...
	knownSymbols->leap_year_ = SymbolTableInt_AddFast(symbolTable, leap_year_);
	...
	knownSymbols->minute = SymbolTableInt_AddFast(symbolTable, minute);
	knownSymbols->minutes = SymbolTableInt_AddFast(symbolTable, minutes);
	knownSymbols->mod = SymbolTableInt_AddFast(symbolTable, mod);
	knownSymbols->month = SymbolTableInt_AddFast(symbolTable, month);
	knownSymbols->months = SymbolTableInt_AddFast(symbolTable, months);
	knownSymbols->name = SymbolTableInt_AddFast(symbolTable, name);
	knownSymbols->nanos = SymbolTableInt_AddFast(symbolTable, nanos);
	...
	knownSymbols->second = SymbolTableInt_AddFast(symbolTable, second);
	knownSymbols->seconds = SymbolTableInt_AddFast(symbolTable, seconds);
	...
	knownSymbols->value = SymbolTableInt_AddFast(symbolTable, value);
	...
	knownSymbols->year = SymbolTableInt_AddFast(symbolTable, year);
	knownSymbols->years = SymbolTableInt_AddFast(symbolTable, years);
