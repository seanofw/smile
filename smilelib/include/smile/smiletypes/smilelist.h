...
SMILE_API_FUNC SmileList SmileList_SafeTail(SmileList list, Int *length);
SMILE_API_FUNC SmileList SmileList_SafeClone(SmileList list, SmileList *newTail, Int *length);
SMILE_API_FUNC SmileList SmileList_SafeCloneTo(SmileList list, Int limit, SmileList *newTail, Int *length);
