...
#ifndef __SMILE_PLATFORM_MACOSX_CLANG_X64_PLATFORM_H__
#define __SMILE_PLATFORM_MACOSX_CLANG_X64_PLATFORM_H__

//------------------------------------------------------------------------------------------------
//  OS: Mac OSX.  Compiler: clang.  Architecture: Intel x64.
...
#define SMILE_OS	SMILE_OS_MACOSX
#define SMILE_CPU	SMILE_CPU_X64
#define SMILE_COMPILER	SMILE_COMPILER_CLANG
