...
typedef enum SmileSpecialSymbolEnum {
	...
	SMILE_SPECIAL_SYMBOL__DOT	= 19,
	SMILE_SPECIAL_SYMBOL__IS	= 20,
	SMILE_SPECIAL_SYMBOL__TYPEOF	= 21,
		
	// Special keywords.	
	SMILE_SPECIAL_SYMBOL_VAR	= 22,
	SMILE_SPECIAL_SYMBOL_CONST	= 23,
	SMILE_SPECIAL_SYMBOL_AUTO	= 24,		
	SMILE_SPECIAL_SYMBOL_KEYWORD	= 25,
	SMILE_SPECIAL_SYMBOL_IF = 26,
	SMILE_SPECIAL_SYMBOL_UNLESS = 27,
	SMILE_SPECIAL_SYMBOL_THEN = 28,
	SMILE_SPECIAL_SYMBOL_ELSE = 29,
	SMILE_SPECIAL_SYMBOL_DO = 30,
	SMILE_SPECIAL_SYMBOL_WHILE = 31,
	SMILE_SPECIAL_SYMBOL_UNTIL = 32,
	SMILE_SPECIAL_SYMBOL_TILL = 33,
	SMILE_SPECIAL_SYMBOL_WHEN = 34,
	SMILE_SPECIAL_SYMBOL_RETURN = 35,
	SMILE_SPECIAL_SYMBOL_TRY	= 36,
	SMILE_SPECIAL_SYMBOL_CATCH	= 37,
	SMILE_SPECIAL_SYMBOL_NOT	= 38,
	SMILE_SPECIAL_SYMBOL_OR	= 39,
	SMILE_SPECIAL_SYMBOL_AND	= 40,
	SMILE_SPECIAL_SYMBOL_NEW	= 41,
	SMILE_SPECIAL_SYMBOL_IS	= 42,
	SMILE_SPECIAL_SYMBOL_TYPEOF	= 43,
		
	// Comparison punctuation.	
	SMILE_SPECIAL_SYMBOL_SUPEREQ	= 44,
	SMILE_SPECIAL_SYMBOL_SUPERNE	= 45,	
	SMILE_SPECIAL_SYMBOL_EQ	= 46,
	SMILE_SPECIAL_SYMBOL_NE	= 47,
	SMILE_SPECIAL_SYMBOL_LT	= 48,
	SMILE_SPECIAL_SYMBOL_GT	= 49,
	SMILE_SPECIAL_SYMBOL_LE	= 50,
	SMILE_SPECIAL_SYMBOL_GE	= 51,
		
	// Arithmetic.	
	SMILE_SPECIAL_SYMBOL_PLUS	= 52,
	SMILE_SPECIAL_SYMBOL_MINUS	= 53,
	SMILE_SPECIAL_SYMBOL_STAR	= 54,
	SMILE_SPECIAL_SYMBOL_SLASH	= 55,
		
	// Braces and brackets.	
	SMILE_SPECIAL_SYMBOL_LEFTPARENTHESIS	= 56,
	SMILE_SPECIAL_SYMBOL_RIGHTPARENTHESIS	= 57,
	SMILE_SPECIAL_SYMBOL_LEFTBRACKET	= 58,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACKET	= 59,
	SMILE_SPECIAL_SYMBOL_LEFTBRACE	= 60,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACE	= 61,
		
	// Other punctuation.	
	SMILE_SPECIAL_SYMBOL_COMMA	= 62,
	SMILE_SPECIAL_SYMBOL_SEMICOLON	= 63,
	SMILE_SPECIAL_SYMBOL_COLON	= 64,
	SMILE_SPECIAL_SYMBOL_QUESTIONMARK	= 65,
	SMILE_SPECIAL_SYMBOL_IMPLIES	= 66,
	SMILE_SPECIAL_SYMBOL_CARET	= 67,
	SMILE_SPECIAL_SYMBOL_ATSIGN = 68,
	SMILE_SPECIAL_SYMBOL_SHL	= 69,
	SMILE_SPECIAL_SYMBOL_SHR	= 70,
	SMILE_SPECIAL_SYMBOL_SAL	= 71,
	SMILE_SPECIAL_SYMBOL_SAR	= 72,
	SMILE_SPECIAL_SYMBOL_ROL	= 73,
	SMILE_SPECIAL_SYMBOL_ROR	= 74,
		
	// Special #syntax classes.	
	SMILE_SPECIAL_SYMBOL_STMT	= 75,
	SMILE_SPECIAL_SYMBOL_EXPR	= 76,
	SMILE_SPECIAL_SYMBOL_CMPEXPR	= 77,
	SMILE_SPECIAL_SYMBOL_ADDEXPR	= 78,
	SMILE_SPECIAL_SYMBOL_MULEXPR	= 79,
	SMILE_SPECIAL_SYMBOL_BINARYEXPR	= 80,
	SMILE_SPECIAL_SYMBOL_COLONEXPR	= 81,
	SMILE_SPECIAL_SYMBOL_RANGEEXPR	= 82,
	SMILE_SPECIAL_SYMBOL_PREFIXEXPR	= 83,
	SMILE_SPECIAL_SYMBOL_POSTFIXEXPR	= 84,
	SMILE_SPECIAL_SYMBOL_CONSEXPR	= 85,
	SMILE_SPECIAL_SYMBOL_DOTEXPR	= 86,
	SMILE_SPECIAL_SYMBOL_TERM	= 87,
	SMILE_SPECIAL_SYMBOL_NAME	= 88,

	// The special 'get-member' and 'set-member' method names.
	SMILE_SPECIAL_SYMBOL_GET_MEMBER	= 89,
	SMILE_SPECIAL_SYMBOL_SET_MEMBER = 90,

	// Miscellaneous.
	SMILE_SPECIAL_SYMBOL_AS = 91,
