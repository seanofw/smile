...
typedef enum SmileSpecialSymbolEnum {
	...
	SMILE_SPECIAL_SYMBOL_ATSIGN = 67,
	SMILE_SPECIAL_SYMBOL_SHL	= 68,
	SMILE_SPECIAL_SYMBOL_SHR	= 69,
	SMILE_SPECIAL_SYMBOL_SAL	= 70,
	SMILE_SPECIAL_SYMBOL_SAR	= 71,
	SMILE_SPECIAL_SYMBOL_ROL	= 72,
	SMILE_SPECIAL_SYMBOL_ROR	= 73,
		
	// Special #syntax classes.	
	SMILE_SPECIAL_SYMBOL_STMT	= 74,
	SMILE_SPECIAL_SYMBOL_EXPR	= 75,
	SMILE_SPECIAL_SYMBOL_CMPEXPR	= 76,
	SMILE_SPECIAL_SYMBOL_ADDEXPR	= 77,
	SMILE_SPECIAL_SYMBOL_MULEXPR	= 78,
	SMILE_SPECIAL_SYMBOL_BINARYEXPR	= 79,
	SMILE_SPECIAL_SYMBOL_COLONEXPR	= 80,
	SMILE_SPECIAL_SYMBOL_RANGEEXPR	= 81,
	SMILE_SPECIAL_SYMBOL_PREFIXEXPR	= 82,
	SMILE_SPECIAL_SYMBOL_POSTFIXEXPR	= 83,
	SMILE_SPECIAL_SYMBOL_CONSEXPR	= 84,
	SMILE_SPECIAL_SYMBOL_DOTEXPR	= 85,
	SMILE_SPECIAL_SYMBOL_TERM	= 86,
	SMILE_SPECIAL_SYMBOL_NAME	= 87,

	// The special 'get-member' and 'set-member' method names.
	SMILE_SPECIAL_SYMBOL_GET_MEMBER	= 88,
	SMILE_SPECIAL_SYMBOL_SET_MEMBER = 89,

	// Miscellaneous.
	SMILE_SPECIAL_SYMBOL_AS = 90,
