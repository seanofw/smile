...
typedef enum SmileSpecialSymbolEnum {
	...
	SMILE_SPECIAL_SYMBOL__INDEX	= 20,
	SMILE_SPECIAL_SYMBOL__IS	= 21,
	SMILE_SPECIAL_SYMBOL__TYPEOF	= 22,
		
	// Special keywords.	
	SMILE_SPECIAL_SYMBOL_VAR	= 23,
	SMILE_SPECIAL_SYMBOL_CONST	= 24,
	SMILE_SPECIAL_SYMBOL_AUTO	= 25,		
	SMILE_SPECIAL_SYMBOL_KEYWORD	= 26,
	SMILE_SPECIAL_SYMBOL_IF = 27,
	SMILE_SPECIAL_SYMBOL_UNLESS = 28,
	SMILE_SPECIAL_SYMBOL_THEN = 29,
	SMILE_SPECIAL_SYMBOL_ELSE = 30,
	SMILE_SPECIAL_SYMBOL_DO = 31,
	SMILE_SPECIAL_SYMBOL_WHILE = 32,
	SMILE_SPECIAL_SYMBOL_UNTIL = 33,
	SMILE_SPECIAL_SYMBOL_TILL = 34,
	SMILE_SPECIAL_SYMBOL_WHEN = 35,
	SMILE_SPECIAL_SYMBOL_RETURN = 36,
	SMILE_SPECIAL_SYMBOL_TRY	= 37,
	SMILE_SPECIAL_SYMBOL_CATCH	= 38,
	SMILE_SPECIAL_SYMBOL_NOT	= 39,
	SMILE_SPECIAL_SYMBOL_OR	= 40,
	SMILE_SPECIAL_SYMBOL_AND	= 41,
	SMILE_SPECIAL_SYMBOL_NEW	= 42,
	SMILE_SPECIAL_SYMBOL_IS	= 43,
	SMILE_SPECIAL_SYMBOL_TYPEOF	= 44,
		
	// Comparison punctuation.	
	SMILE_SPECIAL_SYMBOL_SUPEREQ	= 45,
	SMILE_SPECIAL_SYMBOL_SUPERNE	= 46,	
	SMILE_SPECIAL_SYMBOL_EQ	= 47,
	SMILE_SPECIAL_SYMBOL_NE	= 48,
	SMILE_SPECIAL_SYMBOL_LT	= 49,
	SMILE_SPECIAL_SYMBOL_GT	= 50,
	SMILE_SPECIAL_SYMBOL_LE	= 51,
	SMILE_SPECIAL_SYMBOL_GE	= 52,
		
	// Arithmetic.	
	SMILE_SPECIAL_SYMBOL_PLUS	= 53,
	SMILE_SPECIAL_SYMBOL_MINUS	= 54,
	SMILE_SPECIAL_SYMBOL_STAR	= 55,
	SMILE_SPECIAL_SYMBOL_SLASH	= 56,
		
	// Braces and brackets.	
	SMILE_SPECIAL_SYMBOL_LEFTPARENTHESIS	= 57,
	SMILE_SPECIAL_SYMBOL_RIGHTPARENTHESIS	= 58,
	SMILE_SPECIAL_SYMBOL_LEFTBRACKET	= 59,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACKET	= 60,
	SMILE_SPECIAL_SYMBOL_LEFTBRACE	= 61,
	SMILE_SPECIAL_SYMBOL_RIGHTBRACE	= 62,
		
	// Other punctuation.	
	SMILE_SPECIAL_SYMBOL_COMMA	= 63,
	SMILE_SPECIAL_SYMBOL_SEMICOLON	= 64,
	SMILE_SPECIAL_SYMBOL_COLON	= 65,
	SMILE_SPECIAL_SYMBOL_QUESTIONMARK	= 66,
	SMILE_SPECIAL_SYMBOL_IMPLIES	= 67,
	SMILE_SPECIAL_SYMBOL_CARET	= 68,
	SMILE_SPECIAL_SYMBOL_ATSIGN = 69,
	SMILE_SPECIAL_SYMBOL_SHL	= 70,
	SMILE_SPECIAL_SYMBOL_SHR	= 71,
	SMILE_SPECIAL_SYMBOL_SAL	= 72,
	SMILE_SPECIAL_SYMBOL_SAR	= 73,
	SMILE_SPECIAL_SYMBOL_ROL	= 74,
	SMILE_SPECIAL_SYMBOL_ROR	= 75,
		
	// Special #syntax classes.	
	SMILE_SPECIAL_SYMBOL_STMT	= 76,
	SMILE_SPECIAL_SYMBOL_EXPR	= 77,
	SMILE_SPECIAL_SYMBOL_CMPEXPR	= 78,
	SMILE_SPECIAL_SYMBOL_ADDEXPR	= 79,
	SMILE_SPECIAL_SYMBOL_MULEXPR	= 80,
	SMILE_SPECIAL_SYMBOL_BINARYEXPR	= 81,
	SMILE_SPECIAL_SYMBOL_COLONEXPR	= 82,
	SMILE_SPECIAL_SYMBOL_RANGEEXPR	= 83,
	SMILE_SPECIAL_SYMBOL_PREFIXEXPR	= 84,
	SMILE_SPECIAL_SYMBOL_POSTFIXEXPR	= 85,
	SMILE_SPECIAL_SYMBOL_CONSEXPR	= 86,
	SMILE_SPECIAL_SYMBOL_DOTEXPR	= 87,
	SMILE_SPECIAL_SYMBOL_TERM	= 88,
	SMILE_SPECIAL_SYMBOL_NAME	= 89,

	// The special 'get-member' and 'set-member' method names.
	SMILE_SPECIAL_SYMBOL_GET_MEMBER	= 90,
	SMILE_SPECIAL_SYMBOL_SET_MEMBER = 91,

	// Miscellaneous.
	SMILE_SPECIAL_SYMBOL_AS = 92,
