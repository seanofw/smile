...
SMILE_API_FUNC Int String_CountOf(const String str, const String pattern, Int start);
...
SMILE_API_FUNC String String_ReplaceNewlines(const String str, String replacement);
SMILE_API_FUNC SmileList String_SplitNewlines(const String str);
SMILE_API_FUNC String String_PrefixNewlines(const String str, const String prefix);
...
SMILE_API_FUNC Int String_CountOfI(const String str, const String pattern, Int start);
